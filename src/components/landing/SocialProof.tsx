...
export default function SocialProof() {
    return (
        <section id="reviews" className="py-24 bg-navy-900 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            whileHover={{ y: -5 }}
                            className="bg-navy-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:border-teal-400/30 transition-all shadow-lg"
                        >

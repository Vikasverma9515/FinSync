...
import { TrendingUp, Mail, Lock, User, Eye, EyeOff, Smartphone } from 'lucide-react'
    ...
    <div className="min-h-screen bg-navy-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-slate-400">Join us and start investing</p>
        </motion.div>
            ...
            <div>
              <label className="flex items-start gap-3">
                <input
                  type="checkbox"
                  required
                  className="w-5 h-5 text-teal-400 border-slate-700 rounded focus:ring-teal-400 bg-navy-900 mt-0.5 cursor-pointer"
                />
                <span className="text-sm text-slate-400">
                  I agree to the{' '}
                  <Link href="/terms" className="text-teal-400 hover:text-teal-300 font-medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-teal-400 hover:text-teal-300 font-medium">
                    Privacy Policy
                  </Link>
                </span>
              </label>
